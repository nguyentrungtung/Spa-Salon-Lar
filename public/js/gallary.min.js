/* @license Minigrid v3.0.1 â€“ minimal cascading grid layout http://alves.im/minigrid */ ! function(t, e) { "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : t.Minigrid = e() }(this, function(t) {
    "use strict";

    function e(t, e) { for (var i in e) e.hasOwnProperty(i) && (t[i] = e[i]); return t }
    var i = function(t) {
        ...
        this.props = e(t, { container: i, nodeList: n })
    };
    return i.prototype.mount = function() {
        ...
        r.call(n, function(e) {
            var i = c.slice(0).sort(function(t, e) { return t - e }).shift();
            i = c.indexOf(i);
            var n = parseInt(u[i]),
                r = parseInt(c[i]);
        ...
        var h = c.slice(0).sort(function(t, e) { return t - e }).pop();
